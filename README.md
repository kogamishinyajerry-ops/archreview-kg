...
- P41：Studio readiness workbench。`review_workbench.json` 与结果页“审图工作台总览”把分散 evidence 汇总成 reviewer 入口，提供 action links 跳到对应面板，并提供 `archkg review-state` 本地复核状态操作模板；主规则结论不变。
